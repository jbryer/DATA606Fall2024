...
* The course syllabus located here: https://`r tolower(semester)``r year`.data606.net We will post all course materials there. Blackboard will be used primarily for submitting assignments. Please read the syllabus carefully! Send us any questions you may still have about the course.
...
* [Join the Slack channel by clicking here](`r formative_assessment`) (or use your @sps.cuny.edu email address). This will be our primary mode of communication. 

* For private communications, you can either send private Slack messages or email us at [jason.bryer@cuny.edu and angela.lui@cuny.edu](mailto:jason.bryer@cuny.edu,angela.lui@cuny.edu?subject=DATA606).

* Complete the self-regulated learning assessment in DAACS. Visit [/assignments/daacs/](/assignments/daacs/) for more information.
